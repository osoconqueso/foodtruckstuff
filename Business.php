...
class Business
{
    ...
    /**
     * General region of town the food truck is in
     *
     * @var string
     */
    public $region;
    ...
    public function __construct($business_id)
    {
        ...
        //assign the results
        $this->truck_name = $this->business_results->name;
        //$this->region = $this->business_results->image_url;
        $this->yelp_url = $this->business_results->url;
        $this->m_yelp_url = $this->business_results->mobile_url;
        $this->phone = $this->business_results->display_phone;
    ...
    private function insert_business()
    {
        ...
        $query = $mysql->db->prepare('INSERT INTO trucks (truck_name, region, yelp_url, m_yelp_url, phone, rating, review_count, lat, lng) ' .
            'VALUES (?,?,?,?,?,?,?,?,?)');
        $query->execute(array(
            $this->truck_name,
            $this->region,
